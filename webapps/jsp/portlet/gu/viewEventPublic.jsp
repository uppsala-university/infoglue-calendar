			...
			<li class="dtstart">
               ...
               <ww:if test="this.formatDate(event.startDateTime.time, 'HH:mm') != '12:34'">
				...
				<span class="value">
                                    ...
                                    <ww:property value="this.formatDate(event.startDateTime.getTime(), #timeFormat)"/></span>
...
<ww:property value="this.getLabel('labels.public.event.klockLabel')"/>
			...
			<ww:if test="#eventVersion.eventUrl != null && #eventVersion.eventUrl != ''">
				<li><a class="url uid webPage" href="<ww:property value="#eventVersion.eventUrl"/>">
                                       

                                           
                                        
                                        <ww:property value="this.getLabel('labels.public.event.eventUrl ')"/></a></li>
			</ww:if>
			...
			<ww:if test="event.maximumParticipants != null && event.maximumParticipants != 0">
				<li><ww:property value="this.getLabel('labels.public.event.numberOfSeatsLabel')"/>: <ww:property value="event.maximumParticipants"/> (<ww:property value="this.getLabel('labels.public.event.ofWhichLabel')"/> <ww:property value="event.entries.size()"/> <ww:property value="this.getLabel('labels.public.event.isBookedLabel')"/>)</li>
			</ww:if>
			<ww:if test="event.lastRegistrationDateTime != null">
				<li>	
