...
<ww:if test="#rowstatus.count <= numberOfItems">
	...
	<li class="record">
		...
		<p class="urlAndTitle"><a href="<ww:property value="#attr.detailUrl"/><c:out value="${delim}"/>eventId=<ww:property value="top.id"/>" title="<ww:property value="#eventVersion.title"/>"><ww:property value="#eventVersion.name"/></a></p>
		<p class="date"><ww:property value="this.formatDate(top.startDateTime.getTime(), 'd MMM')"/> 
