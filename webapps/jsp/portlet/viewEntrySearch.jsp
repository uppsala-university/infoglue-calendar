...
<c:set var="activeEventSubNavItem" value="EntrySearch" scope="page"/>
...
<div class="mainCol">
    ...
    <div id="searchForm" class="portlet_margin" style="display: <ww:if test="entries == null">block</ww:if><ww:else>none</ww:else>;">
        ...
        <ww:iterator value="categoryAttributes" status="rowstatus">
            ...
            <calendar:selectField label="top.name" name="${categoryAttributeName}" multiple="true" value="top.category.getSortedChildren(languageCode)" selectedValues="getCategoryAttributeValues(top.id)" cssClass="listBox" required="false"/>
        </ww:iterator>
