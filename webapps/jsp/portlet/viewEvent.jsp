	...
	<div id="inputDiv">		
		<div class="portlet_margin is-margin-bottom">
			...
			<div class="portlet_margin">
				...
				<%-- Event title --%>
				<ww:if test="eventVersion.name != null && eventVersion.name != ''">
					<p>
				...
				<%-- Internal or open --%>  
				<ww:if test="this.isActiveEventField('isInternal') && event.isInternal != null &&  event.isInternal != ''">
					<p>
				...
				<%-- Lecturer --%>  
				<ww:if test="this.isActiveEventField('lecturer') && eventVersion.lecturer != null && eventVersion.lecturer != ''">
					<p>
				...
				<ww:if test="event.endDateTime.time != null && event.endDateTime.time != ''">
					<p>
				...
				<%-- Location --%> 
				<ww:if test="event.locations != null && event.locations != ''">
					<p>
				...
				<ww:if test="this.isActiveEventField('alternativeLocation') && eventVersion.alternativeLocation != null && eventVersion.alternativeLocation != ''">
					<p>
				...
				<%-- Custom location --%>  
				<ww:if test="this.isActiveEventField('customLocation') && eventVersion.customLocation != null && eventVersion.customLocation != ''">
					<p>
				...
				<%-- Organizer name --%>
				<ww:if test="this.isActiveEventField('organizerName') && eventVersion.organizerName != null && eventVersion.organizerName != ''">
					<p>
				...
				<%-- Homepage --%>    
				<ww:if test="this.isActiveEventField('eventUrl') && eventVersion.eventUrl != null && eventVersion.eventUrl != ''">
					<p>
				...
				<%-- Contact name --%>
				<ww:if test="this.isActiveEventField('contactName') && event.contactName != null && event.contactName != ''">
					<p>
				...
				<%-- Contact email --%>  
				<ww:if test="this.isActiveEventField('contactEmail') && event.contactEmail != null && event.contactEmail != ''">
					<p>
				...
				<%-- Contact phone --%>  
				<ww:if test="this.isActiveEventField('contactPhone') && event.contactPhone != null && event.contactPhone != ''">
					<p>
				...
				<%-- Participation fee --%>  
				<ww:if test="this.isActiveEventField('price') && event.price != null && event.price != ''">
					<p>
				...
				<ww:if test="event.maximumParticipants != null && event.maximumParticipants != ''">			
					<p>
				...
				<ww:if test="event.lastRegistrationDateTime != null && event.lastRegistrationDateTime != ''">	
					<p>
