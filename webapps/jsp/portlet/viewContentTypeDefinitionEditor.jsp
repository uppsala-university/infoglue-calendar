    ...
    <div id="attributes">
        ...
        <ww:iterator value="contentTypeAttributes" status="rowstatus">
            ...
            <ww:else>
                ...
                ><div class="columnLong">
                    <p><a name="<ww:property value="#attribute.name"/>" href="javascript:showPropertyDiv('<ww:property value="#attribute.name"/>PropertyLayer');">
                    <ww:property value="#attribute.name"/> (<c:out value="${title}"/>) of type <c:out value="${attribute.inputType}"/></a></p>
                </div>
                <div class="columnEnd">
                    <p><a href="<c:out value="${deleteAttributeUrl}"/>" class="delete"></a>
                    <a href="javascript:showPropertyDiv('<ww:property value="#attribute.name"/>PropertyLayer');" class="edit"></a></p>
                </div>
                <div class="clear"></div>
            </div>
