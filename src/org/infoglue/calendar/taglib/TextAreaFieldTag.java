...
public class TextAreaFieldTag extends AbstractCalendarTag 
{
	...
	public int doEndTag() throws JspException
    {
	    ...
	    log.debug("wysiwygToolbar: " + wysiwygToolbar);
	    if (wysiwygToolbar != null && !"".equals(wysiwygToolbar))
	    {
	    	sb.append("<script type=\"text/javascript\">CKEDITOR.replace( '" + name + "', {toolbar: '" + wysiwygToolbar + "'} );</script>");
	    }
