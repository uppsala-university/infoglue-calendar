...
public class SelectFieldTag extends AbstractCalendarTag 
{
	...
	public int doEndTag() throws JspException
    {
        ...
        sb.append("<select id=\"" + name + "\" name=\"" + name + "\" " + (multiple.equals("false") ? "" : "multiple=\"true\"") + " " + (size.equals("") ? "" : "size=\"" + size + "\"") + "tabindex=\"" + tabIndex +"\"" +" class=\"" + cssClass + "\">");
    ...
    {
    	try {
			 tabIndex= evaluateString("SelectFieldTag", "tabIndex", tabIndex);
