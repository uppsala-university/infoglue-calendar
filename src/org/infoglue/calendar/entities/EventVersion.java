...
public class EventVersion implements BaseEntity
{
    ...
    */
    ...
    {
    	// If description contains '</p>' it is a WYSIWYG-description and does not need to convert line-breaks
        if(shortDescription != null && shortDescription.indexOf("</p>") == -1)
        {
    ...
    {
        // If description contains '</p>' it is a WYSIWYG-description and does not need to convert line-breaks
        if(longDescription != null && longDescription.indexOf("</p>") == -1)
        {
    		String lineSep = System.getProperty("line.separator");
