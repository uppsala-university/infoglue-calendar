...
public class ViewCalendarAction extends CalendarAbstractAction
{
    ...
    private List eventVersionList;
    
	
	private List allCurrentAndComingPublishEventVersionList;
	private List allCurrentAndComingPublishedEventVersionList;
	private List allCurrentAndComingWorkingEventVersionList;
    ...
    public String execute() throws Exception 
    {
        ...
        java.util.Calendar calendarMinusSevenYears = java.util.Calendar.getInstance();
        calendarMinusSevenYears.add(java.util.Calendar.YEAR, -7); 
    	
    	java.util.Calendar calendarPlusOneYear = java.util.Calendar.getInstance();
    	calendarPlusOneYear.add(java.util.Calendar.YEAR, 1); 

    	java.util.Calendar currentDate = java.util.Calendar.getInstance();
    	
    	/*
    	 * List all working events ever
    	 * */    	
    	
    	//Set allWorkingEvents = EventController.getController().getEventList(this.calendarId, Event.STATE_WORKING, calendarMinusSevenYears, calendarPlusOneYear, getSession());
    	//this.allWorkingEventVersionList = getEventVersionListFromSet(allWorkingEvents);
    	
    	/*
    	 * List all publish events ever
    	 * */
    	//Set allPublishEvents = EventController.getController().getEventList(this.calendarId, Event.STATE_PUBLISH, calendarMinusSevenYears, calendarPlusOneYear, getSession());
    	//this.allPublishEventVersionList = getEventVersionListFromSet(allPublishEvents);
    	/*
    	 * List for all published events ever
    	 * */
    	//Set allPublishedEvents = EventController.getController().getEventList(this.calendarId, Event.STATE_PUBLISHED, calendarMinusSevenYears, calendarPlusOneYear, getSession());
    	//this.allPublishedEventVersionList = getEventVersionListFromSet(allPublishedEvents);
    	/*
    	 * List all current and coming published events
    	 * */
    	Set allCurrentAndComingPublishedEvents = EventController.getController().getEventList(this.calendarId, Event.STATE_PUBLISHED, currentDate, calendarPlusOneYear, getSession());
    	this.allCurrentAndComingPublishedEventVersionList = getEventVersionListFromSet(allCurrentAndComingPublishedEvents);
    	
    	/*
    	 * List all current and coming working events
    	 * */
    	Set allCurrentAndComingWorkingEvents = EventController.getController().getEventList(this.calendarId, Event.STATE_WORKING, currentDate, calendarPlusOneYear, getSession());
    	this.allCurrentAndComingWorkingEventVersionList = getEventVersionListFromSet(allCurrentAndComingWorkingEvents);
    	
    	/*
    	 * List all current and coming working events
    	 * */
    	Set allCurrentAndComingPublishEvents = EventController.getController().getEventList(this.calendarId, Event.STATE_PUBLISH, currentDate, calendarPlusOneYear, getSession());
    	this.allCurrentAndComingPublishEventVersionList = getEventVersionListFromSet(allCurrentAndComingPublishEvents);
     ...
     * @return
     */
    public List getEventVersionListFromSet(Set eventSet) {
    	Iterator iter = eventSet.iterator();
    	
    	List<EventVersion> eventVersionList = new ArrayList();;
    	while (iter.hasNext()) {
    	    Event event = (Event) iter.next();
    	    
    	    eventVersionList.add(EventController.getController().getEventVersion(event, "sv", getSession()));
    	}
    ...
    public List getAllCurrentAndComingPublishEventVersionList() {

		return allCurrentAndComingPublishEventVersionList;
    }
    
    public List getAllCurrentAndComingPublishedEventVersionList() {

		return allCurrentAndComingPublishedEventVersionList;
    }
    public List getAllCurrentAndComingWorkingEventVersionList() {

		return allCurrentAndComingWorkingEventVersionList;
    }
